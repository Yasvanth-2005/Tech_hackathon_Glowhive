    ...
    <Layout>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-purple-800 mb-4 md:mb-0">Admin Management</h1>
          <button
            className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-lg transition duration-300 ease-in-out flex items-center"
        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden">
          ...
          {loading ? (
            <div className="text-center py-10">
              ...
              <p className="mt-2 text-purple-600">Loading admins...</p>
            </div>
          ) : (
